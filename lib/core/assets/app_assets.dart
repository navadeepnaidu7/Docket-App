...
abstract final class AppAssets {
  ...
  /// Packed land-dot field and India state outlines for the Journey globe.
  ///
  /// Binary, not JSON: it is pure numbers and lands on the frame the user opens
  /// Journey, which is the one frame that must not jank. Generated by
  /// tool/generate_journey_atlas.py.
  static const String journeyAtlas = 'assets/journey/atlas_v1.bin';

  /// Curated place table mapping station codes, city names and venue names to
  /// coordinates. JSON on purpose — it is hand-edited, so it has to stay
  /// readable in a diff.
  static const String journeyPlaces = 'assets/journey/places_v1.json';
