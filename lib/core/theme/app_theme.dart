...
class AppTheme {
  ...
  static const Color _lightSurface = Color(0xFFFBF8F2); // lighter cream for cards
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(radiusInput),
          borderSide: isDark
              ? BorderSide(color: Colors.white.withValues(alpha: 0.07), width: 0.5)
              : BorderSide.none,
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(radiusInput),
          borderSide: BorderSide(color: primary.withValues(alpha: 0.55), width: 1.0),
        ),
      ),
