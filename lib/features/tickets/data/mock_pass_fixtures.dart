...
final List<TrainPass> mockTrainPasses = <TrainPass>[
  TrainPass(
    ...
    codePayload: 'IRCTC|1234567890|SBC|MAS|2026-08-26|3A',
  ...
  TrainPass(
    ...
    pnr: '4109823761',
    bookingId: 'E23456789',
    codePayload: 'IRCTC|4109823761|NDLS|BCT|2026-08-27|2A',
    status: TicketStatus.active,
  ...
  TrainPass(
    ...
    pnr: '6637291048',
    bookingId: 'E34567890',
    codePayload: 'IRCTC|6637291048|MAS|SBC|2026-08-28|SL',
    status: TicketStatus.active,
...
final List<MoviePass> mockMoviePasses = <MoviePass>[
  MoviePass(
    ...
    codePayload: 'BMSQR8F2K9P1QW4XN7T2',
    orderId: 'ORD99763JS',
    status: TicketStatus.active,
  ...
  MoviePass(
    ...
    codePayload: 'DSTQR4A71C2E9M6HB3V9',
    orderId: 'DZM8821456',
    status: TicketStatus.active,
    posterHint: MoviePosterHint.sciFi,
    certification: 'UA',
  ...
  MoviePass(
    ...
    codePayload: 'TKTQRGBD99763Z1RC8Y5',
    orderId: 'GBD99763JS',
    status: TicketStatus.active,
...
final List<BusPass> mockBusPasses = <BusPass>[
  BusPass(
    ...
    date: _dateIn(2),
    arrivalDate: _dateIn(2),
    departAt: _departsIn(2, 8, 30),
    arriveAt: _departsIn(2, 11, 45),
    seatDetails: '12A',
    fare: '₹650',
    ...
    bookingId: 'RB8842119',
    codePayload: 'RBQR8842119LP3KD7NQ',
    status: TicketStatus.active,
  ),
  BusPass(
    id: 'mock_b2',
    ...
    fromCity: 'Bengaluru',
    toCity: 'Mangaluru',
    boardingLocation: 'Bengaluru, Shantinagar Bus Station',
    dropLocation: 'Mangaluru, State Bank Bus Stand',
    platform: 'Bay 4',
    departTime: '11:15 PM',
    arriveTime: '05:30 AM',
    date: _dateIn(9),
    ...
    bookingId: 'KA5510073',
    codePayload: 'KSRTCQR5510073XV8MB2',
    status: TicketStatus.active,
  ),
  const BusPass(
    id: 'mock_b3',
    ...
    fromCity: 'Pune',
    toCity: 'Goa',
    boardingLocation: 'Pune, Swargate Bus Terminal',
    dropLocation: 'Goa, Panaji Kadamba Stand',
    platform: 'Platform 6',
    departTime: '09:00 PM',
    arriveTime: '06:10 AM',
    date: '18 Feb 2026',
