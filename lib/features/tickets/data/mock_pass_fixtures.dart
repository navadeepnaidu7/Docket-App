...
final List<MoviePass> mockMoviePasses = <MoviePass>[
  ...
  // ── Deeper archive ──────────────────────────────────────────────────────
  //
  // Enough finished bookings, spread across years, for Archive > Movies to
  // read as a shelf of posters rather than a stub. Every posterUrl below was
  // checked against image.tmdb.org and returns real bytes; a mistyped hash
  // would 404 silently and render the gradient instead.
  //
  // No logoUrl: these are all expired, so they never render a glance card,
  // and the detail face uses the poster.
  MoviePass(
    id: 'movie_bms_3',
    brand: MoviePassBrand.bookMyShow,
    ...
    cinemaAddress: 'Gachibowli, Hyderabad',
    screen: 'Screen 4',
    showDate: 'Fri, 27 Sep 2024',
    showTime: '6:00 PM',
    format: '2D',
    language: 'Telugu',
    seats: const <MovieSeat>[
      MovieSeat(row: 'G', number: '11'),
      MovieSeat(row: 'G', number: '12'),
    ],
    bookingId: 'BMS-5D8E2F10',
    orderId: 'ORD55218TG',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.action,
    certification: 'UA',
    runtime: '2h 55m',
    // TMDB 811941
    posterUrl: _mockPosterUrl('lQfuaXjANoTsdx5iS0gCXlK9D2L.jpg'),
  ),
  MoviePass(
    id: 'movie_dist_3',
    brand: MoviePassBrand.district,
    movieTitle: 'Stree 2',
    movieSubtitle: 'Horror Comedy · UA',
    cinemaName: 'INOX GVK One',
    cinemaAddress: 'Banjara Hills, Hyderabad',
    screen: 'Audi 2',
    showDate: 'Thu, 15 Aug 2024',
    showTime: '8:30 PM',
    format: '2D',
    language: 'Hindi',
    seats: const <MovieSeat>[
      MovieSeat(row: 'E', number: '07'),
      MovieSeat(row: 'E', number: '08'),
      MovieSeat(row: 'E', number: '09'),
    ],
    bookingId: 'DST-2B44A9C7',
    orderId: 'DZM7710233',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.comedy,
    certification: 'UA',
    runtime: '2h 23m',
    // TMDB 1112426
    posterUrl: _mockPosterUrl('2NC7sj8rheKxWqLYAbHnCa4mYBH.jpg'),
  ),
  MoviePass(
    id: 'movie_uni_2',
    brand: MoviePassBrand.universal,
    movieTitle: 'Gladiator II',
    movieSubtitle: 'Action · UA 16+',
    cinemaName: 'PVR Nexus',
    cinemaAddress: 'Kukatpally, Hyderabad',
    screen: 'Screen 6',
    showDate: 'Fri, 22 Nov 2024',
    showTime: '9:15 PM',
    format: 'IMAX 2D',
    language: 'English',
    seats: const <MovieSeat>[MovieSeat(row: 'C', number: '04')],
    bookingId: 'TKT-GL2X8841',
    orderId: 'GL2X8841PV',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.action,
    certification: 'UA 16+',
    ...
    sourcePlatform: 'PVR',
    // TMDB 558449
    posterUrl: _mockPosterUrl('2cxhvwyEwRlysAmRH4iodkvo0z5.jpg'),
  ),
  MoviePass(
    id: 'movie_bms_4',
    brand: MoviePassBrand.bookMyShow,
    movieTitle: 'Salaar: Part 1 — Ceasefire',
    movieSubtitle: 'Action · A',
    cinemaName: 'Prasads Multiplex',
    cinemaAddress: 'NTR Gardens, Hyderabad',
    screen: 'Screen 1 · IMAX',
    showDate: 'Fri, 22 Dec 2023',
    showTime: '11:00 AM',
    format: 'IMAX 2D',
    language: 'Telugu',
    seats: const <MovieSeat>[
      MovieSeat(row: 'M', number: '20'),
      MovieSeat(row: 'M', number: '21'),
    ],
    bookingId: 'BMS-7E1A9B33',
    orderId: 'ORD31908SL',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.action,
    certification: 'A',
    runtime: '2h 55m',
    // TMDB 770906
    posterUrl: _mockPosterUrl('nlu9WbcetNFRGXXPWITr30ob7W6.jpg'),
  ),
  MoviePass(
    id: 'movie_dist_4',
    brand: MoviePassBrand.district,
    movieTitle: 'Animal',
    movieSubtitle: 'Crime Drama · A',
    cinemaName: 'Cinepolis Sudha',
    cinemaAddress: 'Dilsukhnagar, Hyderabad',
    screen: 'Audi 5',
    showDate: 'Sun, 03 Dec 2023',
    showTime: '7:45 PM',
    format: '2D',
    language: 'Hindi',
    seats: const <MovieSeat>[MovieSeat(row: 'H', number: '15')],
    bookingId: 'DST-6F30C812',
    orderId: 'DZM2244019',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.action,
    certification: 'A',
    runtime: '3h 21m',
    // TMDB 781732
    posterUrl: _mockPosterUrl('hr9rjR3J0xBBKmlJ4n3gHId9ccx.jpg'),
  ),
  MoviePass(
    id: 'movie_bms_5',
    brand: MoviePassBrand.bookMyShow,
    movieTitle: 'Jawan',
    movieSubtitle: 'Action Thriller · UA',
    cinemaName: 'INOX Maheshwari',
    cinemaAddress: 'Malakpet, Hyderabad',
    screen: 'Screen 3',
    showDate: 'Thu, 07 Sep 2023',
    showTime: '5:20 PM',
    format: '2D',
    language: 'Hindi',
    seats: const <MovieSeat>[
      MovieSeat(row: 'F', number: '02'),
      MovieSeat(row: 'F', number: '03'),
    ],
    bookingId: 'BMS-3C90D2A5',
    orderId: 'ORD21774JW',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.action,
    certification: 'UA',
    runtime: '2h 49m',
    // TMDB 872906
    posterUrl: _mockPosterUrl('jFt1gS4BGHlK8xt76Y81Alp4dbt.jpg'),
  ),
  MoviePass(
    id: 'movie_uni_3',
    brand: MoviePassBrand.universal,
    movieTitle: 'Oppenheimer',
    movieSubtitle: 'Drama · UA 16+',
    cinemaName: 'AMB Cinemas',
    cinemaAddress: 'Gachibowli, Hyderabad',
    screen: 'Screen 7 · IMAX',
    showDate: 'Sat, 22 Jul 2023',
    showTime: '3:00 PM',
    format: 'IMAX 70mm',
    language: 'English',
    seats: const <MovieSeat>[
      MovieSeat(row: 'J', number: '09'),
      MovieSeat(row: 'J', number: '10'),
    ],
    bookingId: 'TKT-OPP44120',
    orderId: 'OPP44120AM',
    status: TicketStatus.expired,
    posterHint: MoviePosterHint.thriller,
    certification: 'UA 16+',
    runtime: '3h 01m',
    // TMDB 872585
