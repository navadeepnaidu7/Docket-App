...
void main() {
  ...
  group('WalletCardMetrics.resolve', () {
    ...
    // The compact train face keeps the carousel width without the movie's
    // poster-height whitespace.
    test('a train pass keeps movie width with a shorter content canvas', () {
      ...
      expect(train.height, lessThan(movie.height));
      expect(train.height, closeTo(342 * 492 / 366, 0.5));
